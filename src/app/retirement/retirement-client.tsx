...
export interface RetirementClientProps {
  initialRecords: RetirementRecord[];
}

export function RetirementClient({ initialRecords }: RetirementClientProps) {
  const { records, loading, refresh } = useRetirementData({ initialRecords });
