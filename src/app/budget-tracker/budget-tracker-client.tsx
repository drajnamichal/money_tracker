...
import type { BudgetExpense, BudgetTodoItem } from '@/types/financial';

export interface BudgetTrackerClientProps {
  initialExpenses: BudgetExpense[];
  initialTodos: BudgetTodoItem[];
}

export function BudgetTrackerClient({ initialExpenses, initialTodos }: BudgetTrackerClientProps) {
