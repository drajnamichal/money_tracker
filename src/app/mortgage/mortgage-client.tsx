...
import type { Mortgage, MortgagePayment } from '@/types/financial';

export interface MortgageClientProps {
  initialMortgages: Mortgage[];
  initialPayments: MortgagePayment[];
}

export function MortgageClient({ initialMortgages, initialPayments }: MortgageClientProps) {
